  ...
  return (
    <div ref={dropdownRef} className={clsx("relative", className)}>
      <button
        ...
        className={clsx(
          "w-full px-16px py-12px bg-carbon-plate border-2 border-basalt-border",
        ...
        <div className="absolute z-50 mt-8px w-full bg-carbon-plate border-2 border-basalt-border shadow-brutal-md">
          <div className="p-8px border-b-2 border-basalt-border">
            <input
              ...
              className="w-full px-12px py-8px bg-event-horizon/10 border-2 border-basalt-border 
          ...
          <div className="max-h-200px overflow-y-auto">
            {filteredOptions.length === 0 ? (
              <div className="px-16px py-12px text-neutral-500 text-brutal-sm">
                NO OPTIONS FOUND
              </div>
            ) : (
              filteredOptions.map(option => {
                ...
                return (
                  ...
                  >
                    ...
                    {isSelected && <HiOutlineCheck className="w-16px h-16px text-primary-brutalist" />}
                  </button>
                )
              })
            )}
