...
export function WorkspaceIntegrationsTab({ workspace }: WorkspaceIntegrationsTabProps) {
  ...
  const renderIntegrationDetail = (integration: Integration) => {
      ...
      return (
        <div className="space-y-[12px]">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-[14px] font-semibold font-bold mb-8px">GitHub Integration</h3>
          ...
          <div className="grid grid-cols-2 gap-[8px]">
            <div className="p-[10px] bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
          ...
          <div className="p-[10px] bg-brutal-warning/10 border border-brutal-warning">
    ...
    return (
      <div className="text-center py-[24px]">
        <integration.icon className="w-8 h-8 mx-auto mb-[12px]" style={{ color: integration.color }} />
        <h3 className="text-[14px] font-semibold font-bold mb-[8px]">{integration.name}</h3>
        <p className="text-brutal-sm text-[var(--theme-foreground)]/60 mb-[12px] max-w-md mx-auto">
        ...
        {integration.status === 'not_connected' ? (
          ...
          <div className="inline-flex items-center gap-8px px-[12px] py-12px bg-basalt-border/50 text-[var(--theme-foreground)]/60">
  ...
  return (
    <div className="p-[20px]">
      <div className="mb-[16px]">
        <h1 className="text-[16px] font-bold font-bold uppercase mb-8px">WORKSPACE INTEGRATIONS</h1>
        <p className="text-brutal-sm text-[var(--theme-foreground)]/60">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-[12px]">
        ...
        <div className="lg:col-span-1 space-y-[8px]">
          {integrations.map((integration) => (
            <button
              ...
              className={`w-full p-[16px] border-2 transition-all text-left ${selectedIntegration === integration.id
        ...
        <div className="lg:col-span-2">
          <BrutalCard className="p-[20px] min-h-[400px]">
            {selectedIntegration ? (
              renderIntegrationDetail(integrations.find(i => i.id === selectedIntegration)!)
            ) : (
              <div className="text-center py-[24px]">
                <HiOutlineLink className="w-8 h-8 mx-auto mb-[12px] text-[var(--theme-foreground)]/20" />
                <p className="text-brutal-sm text-[var(--theme-foreground)]/60">
      ...
      <div className="mt-[24px]">
        <BrutalCard className="p-[20px]">
          <div className="flex items-center justify-between mb-[12px]">
            <div>
              <h2 className="text-[14px] font-semibold font-bold flex items-center gap-[6px]">
          ...
          <div className="text-center py-[16px] border-2 border-dashed border-[var(--theme-border)]">
