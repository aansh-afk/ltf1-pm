          ...
          {currentAssignees.length === 0 ? (
            ...
            currentAssignees.map((assigneeId) => {
              ...
              return member ? (
                <div
                  key={assigneeId}
                  className="flex items-center gap-6px px-12px py-6px bg-primary-brutalist/20 border border-primary-brutalist"
                >
      ...
      <div className="brutal-card p-16px bg-[var(--theme-background-secondary)]">
          ...
          {extractedTechnologies.length === 0 && manualTechnologies.length === 0 ? (
            ...
            <>
              ...
              {manualTechnologies.map((tech) => (
                <span
                  key={tech}
                  className="flex items-center gap-4px px-8px py-4px font-mono text-brutal-xs bg-brutal-info/20 border border-brutal-info text-brutal-info font-bold"
                >
                  {tech}
                  <button
        ...
        <div className="flex gap-8px">
          ...
          <button
            ...
            className="brutal-btn-secondary px-16px"
          >
            ADD
          </button>
        </div>
