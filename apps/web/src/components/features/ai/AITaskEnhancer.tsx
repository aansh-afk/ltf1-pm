...
export default function AITaskEnhancer({
  ...
  // Helper functions for generating enhancements
  function improveTitle(title: string): string {
    // Add action verbs and clarity
...
- Manual testing checklist`
  ...
  function estimateHours(title: string, description?: string): number {
    ...
    return points * 4 // Rough estimate: 4 hours per point
  }
  
  function generateAcceptanceCriteria(title: string): string[] {
    return [
            ...
            <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
              <label className="flex items-start gap-8px cursor-pointer">
                <input
                  ...
                  onChange={() => toggleEnhancement('improvedTitle')}
                  className="mt-2px"
                />
            ...
            <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
              <label className="flex items-start gap-8px cursor-pointer">
                <input
                  ...
                  onChange={() => toggleEnhancement('suggestedPriority')}
                  className="mt-2px"
                />
                <div className="flex-1">
            ...
            <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
              <label className="flex items-start gap-8px cursor-pointer">
                <input
                  ...
                  onChange={() => toggleEnhancement('suggestedAssignee')}
                  className="mt-2px"
                />
                <div className="flex-1">
                  <p className="text-brutal-xs font-bold uppercase mb-4px flex items-center gap-4px">
              ...
              <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
                <label className="flex items-start gap-8px cursor-pointer">
                  <input
                    ...
                    onChange={() => toggleEnhancement('estimatedPoints')}
                    className="mt-2px"
                  />
                  <div className="flex-1">
              ...
              <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
                <label className="flex items-start gap-8px cursor-pointer">
                  <input
                    ...
                    onChange={() => toggleEnhancement('estimatedHours')}
                    className="mt-2px"
                  />
                  <div className="flex-1">
            ...
            <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
              <label className="flex items-start gap-8px cursor-pointer">
                <input
                  ...
                  onChange={() => toggleEnhancement('labels')}
                  className="mt-2px"
                />
                <div className="flex-1">
            ...
            <div className="p-12px bg-[var(--theme-background-secondary)] border border-[var(--theme-border)]">
              <label className="flex items-start gap-8px cursor-pointer">
                <input
                  ...
                  onChange={() => toggleEnhancement('acceptanceCriteria')}
                  className="mt-2px"
                />
                <div className="flex-1">
                  <p className="text-brutal-xs font-bold uppercase mb-4px flex items-center gap-4px">
                  ...
                  <ul className="list-disc list-inside text-brutal-xs text-[var(--theme-foreground-secondary)]">
                    {enhancements.acceptanceCriteria.map((criteria, i) => (
