...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-24px" 
         style={{ backgroundColor: 'var(--theme-background)' }}>
      <div className="max-w-600px w-full">
        {/* Glitchy 404 Display */}
        <div className="text-center mb-48px">
          <div 
            className="text-[120px] md:text-[180px] font-bold font-mono leading-none mb-24px"
            style={{ 
          ...
          <div className="mb-16px">
            <div 
              className="text-brutal-xl uppercase font-mono"
        ...
        {/* ASCII Art Border */}
        <div 
          className="font-mono text-brutal-xs mb-32px"
...
╚════════════════════════════════════════╝`}
        ...
        {/* Error Details */}
        <div 
          className="border-2 p-24px mb-32px"
          style={{ 
        ...
        <div className="flex flex-col sm:flex-row gap-16px">
          <button
            onClick={() => navigate('/')}
            className="flex-1 px-24px py-16px border-2 font-mono text-brutal-md uppercase tracking-wider transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-brutal"
            style={{
        ...
        {/* Terminal Hint */}
        <div 
          className="mt-48px text-center text-brutal-xs"
