...
// ─────────────────────────────────────────────
// Section sub-components (static — no props)
// ─────────────────────────────────────────────
...
function MultiSelectSection({ multiVal, dispatch }: { multiVal: string[]; dispatch: React.Dispatch<DemoAction> }) {
  return (
    <section>
...
function CheckboxesSection({ check1, check2, check3, dispatch }: {
  check1: boolean; check2: boolean; check3: boolean; dispatch: React.Dispatch<DemoAction>
}) {
  return (
    <section>
...
function TogglesSection({ toggle1, toggle2, toggle3, dispatch }: {
  toggle1: boolean; toggle2: boolean; toggle3: boolean; dispatch: React.Dispatch<DemoAction>
}) {
  return (
    <section>
...
function SlidersSection({ sliderVal, dispatch }: { sliderVal: number; dispatch: React.Dispatch<DemoAction> }) {
  return (
    <section>
...
function ModalsSection({ modalOpen, modalSize, dispatch }: {
  modalOpen: boolean; modalSize: 'sm' | 'md' | 'lg' | 'xl'; dispatch: React.Dispatch<DemoAction>
}) {
...
function SidebarNav({ activeSection, dispatch }: { activeSection: string; dispatch: React.Dispatch<DemoAction> }) {
  return (
  ...
  return (
    <div className="flex min-h-screen bg-[var(--theme-background)]">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-6 py-8 space-y-16">
        ...
        <BadgesSection />
        <AvatarsSection />
        <CheckboxesSection check1={check1} check2={check2} check3={check3} dispatch={dispatch} />
        <TogglesSection toggle1={toggle1} toggle2={toggle2} toggle3={toggle3} dispatch={dispatch} />
        <ProgressSection />
        <SlidersSection sliderVal={sliderVal} dispatch={dispatch} />
        <TableSection />
        <ModalsSection modalOpen={modalOpen} modalSize={modalSize} dispatch={dispatch} />
