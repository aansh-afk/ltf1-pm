    ...
    return (
      <div className="p-48px">
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-48px text-center">
          ...
          <p className="text-[var(--theme-foreground)]/60">Create or select a workspace to view team members</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="p-24px">
      ...
      <div className="mb-32px">
        ...
        <p className="text-[var(--theme-foreground)]/60 text-brutal-sm uppercase">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-16px mb-32px">
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-16px">
          ...
          <div className="font-mono text-brutal-xs uppercase text-[var(--theme-foreground)]/60">AVAILABLE</div>
        </div>
        ...
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-16px">
          ...
          <div className="font-mono text-brutal-xs uppercase text-[var(--theme-foreground)]/60">LOCKED IN</div>
        </div>
        ...
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-16px">
          ...
          <div className="font-mono text-brutal-xs uppercase text-[var(--theme-foreground)]/60">IN REVIEW</div>
        </div>
        ...
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-16px">
          ...
          <div className="font-mono text-brutal-xs uppercase text-[var(--theme-foreground)]/60">IN MEETING</div>
        </div>
        ...
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-16px">
          ...
          <div className="font-mono text-brutal-xs uppercase text-[var(--theme-foreground)]/60">AFK</div>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-16px mb-32px">
        <div className="flex-1 relative">
          <HiOutlineSearch className="absolute left-16px top-1/2 -translate-y-1/2 w-20px h-20px text-[var(--theme-foreground)]/60" />
          <input
            type="text"
            placeholder="SEARCH TEAM MEMBERS..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full pl-48px pr-16px py-12px bg-[var(--theme-background-secondary)] border-2 border-[var(--theme-border)] text-[var(--theme-foreground)] placeholder-cathode-white/40 font-mono text-brutal-sm uppercase focus:border-primary-brutalist focus:outline-none transition-colors"
          />
        </div>
        ...
        <select
          ...
          className="px-16px py-12px bg-[var(--theme-background-secondary)] border-2 border-[var(--theme-border)] text-[var(--theme-foreground)] font-mono text-brutal-sm uppercase focus:border-primary-brutalist focus:outline-none transition-colors"
        >
      ...
      {filteredMembers.length === 0 ? (
        <div className="bg-[var(--theme-background)] border-2 border-[var(--theme-border)] p-48px text-center">
          ...
          <p className="text-[var(--theme-foreground)]/60">No team members found</p>
        </div>
      ) : (
